...
function draw() {
  ...
  textSize(20);
  text("Press the left arrow key to swing the left bob.",190,640);
  text("Press the right arrow key to swing the right bob.",180,670);
}
 function keyPressed() {
	 if (keyCode === LEFT_ARROW) {
		Matter.Body.applyForce(bob1.body, bob1.body.position, {x:-1500, y:0});
	 }
	 if (keyCode === RIGHT_ARROW) {
		Matter.Body.applyForce(bob5.body, bob5.body.position, {x:1500, y:0});
	}
 }
